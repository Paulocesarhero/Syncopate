...
export const DropZone = memo(function DropZone({ onFilesDropped }: DropZoneProps) {
  ...
  return (
    ...
    >
      <div className="drop-zone__content">
        <svg className="drop-zone__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
